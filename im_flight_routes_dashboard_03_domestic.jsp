		...
		rsMain = psMain.executeQuery();  
			...
			{	
				...
				<%															
					...
					else if(flightNumber1.length() == 7 && flightNumber1.substring(6,7).matches("[0-9]+"))
						dep_flt_no = flightNumber1.substring(0,6) + String.valueOf(Integer.parseInt(flightNumber1.substring(6,7)) + 1);
					...
					else if(flightNumber1.length() == 9 && flightNumber1.substring(4,9).matches("[0-9]+"))
						dep_flt_no = flightNumber1.substring(0,4) + String.valueOf(Integer.parseInt(flightNumber1.substring(4,9)) + 1);
					...
					else if(flightNumber1.length() == 10 && flightNumber1.substring(9,10).matches("[0-9]+"))
						dep_flt_no = flightNumber1.substring(0,9) + String.valueOf(Integer.parseInt(flightNumber1.substring(9,10)) + 1);
					else
					...
					selectRevQuery = "SELECT * FROM IM_FLIGHT_ROUTES WHERE FLIGHT_NO = '" + dep_flt_no + "' and SRC_COUNTRY_CODE ='IND'";
