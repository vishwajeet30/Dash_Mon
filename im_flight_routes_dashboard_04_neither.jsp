...
<%				
		...
		else if(flightNumber1.length() == 9 && flightNumber1.substring(7,9).matches("[0-9]+"))
			dep_flt_no = flightNumber1.substring(0,7) + String.valueOf(Integer.parseInt(flightNumber1.substring(7,9)) + 1);
		...
		else if(flightNumber1.length() == 10 && flightNumber1.substring(8,10).matches("[0-9]+"))
			dep_flt_no = flightNumber1.substring(0,8) + String.valueOf(Integer.parseInt(flightNumber1.substring(8,10)) + 1);
		else 
